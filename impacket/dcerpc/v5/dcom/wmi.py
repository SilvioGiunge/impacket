...
class _WBEM_REFRESH_INFO_UNION(NDRUNION):
    ...
    union = {
        WBEM_REFRESH_TYPE.enumItems.WBEM_REFRESH_TYPE_REMOTE    : ('m_Remote', _WBEM_REFRESH_INFO_REMOTE),
        WBEM_REFRESH_TYPE.enumItems.WBEM_REFRESH_TYPE_NON_HIPERF: ('m_NonHiPerf', _WBEM_REFRESH_INFO_NON_HIPERF),
        WBEM_REFRESH_TYPE.enumItems.WBEM_REFRESH_TYPE_INVALID   : ('m_hres', HRESULT),
    }
